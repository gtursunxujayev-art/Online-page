...
export const defaultContent: ContentState = {
  ...
  pricing: {
    ...
    plans: [
      { 
        ...
        features: [
          "4 ta modul bo'yicha videodarslar",
      ...
      { 
        ...
        features: [
          ...
          "Asror Iskandarovdan “Shaxsiy brend qurish” videodarsi",
      ...
      { 
        ...
        features: [
          ...
          "Qo'shimcha 5-Modul",
          "SPECIAL_SECTION_START:Shaxsiy rivojlanish",
          "Muzokara darsi",
          "Foydali odatlarni shakllantirish",
          "Hayot strategiyasi",
          "Bola tarbiyasida nutqning o'rni",
          "Umrni rejalashtirish",
          "SPECIAL_SECTION_END",
  ...
  footer: {
    ...
    address: "Toshkent sh., Chilonzor tumani, Sharq tongi 11",
